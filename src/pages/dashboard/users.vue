...
<template>
  <div class="w-screen h-screen bg-base-100 flex flex-col items-center justify-center">
    <h1 class="text-2xl pb-2">Users Dashboard</h1>
    <div class="grid grid-cols-12 w-11/12 text-center">
    ...
    <div class="grid grid-cols-12 w-11/12 text-center" v-for="user in users" :key="user.id" >
